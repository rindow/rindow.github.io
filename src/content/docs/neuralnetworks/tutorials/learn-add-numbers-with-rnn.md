...
![MNIST Images](/neuralnetworks/tutorials/images/learn-add-numbers-with-rnn-model.svg)
...
$plt->show();
```
![MNIST Images](/neuralnetworks/tutorials/images/learn-add-numbers-with-rnn-training.png)
