...
$plt->show();
```
![CIFAR10 Images](/neuralnetworks/tutorials/images/convolution-neural-network-show-cifar10.png)
...
$plt->show();
```
![CIFAR10 on basic model](/neuralnetworks/tutorials/images/convolution-neural-network-fnn-model.png)
...
$plt->show();
```
![CIFAR10 on basic model](/neuralnetworks/tutorials/images/convolution-neural-network-simple-cnn.png)
...
$plt->show();
```
![Train Progress](/neuralnetworks/tutorials/images/convolution-neural-network-deep-cnn.png)
...
![CIFAR10 Predict](/neuralnetworks/tutorials/images/convolution-neural-network-predict.png)
